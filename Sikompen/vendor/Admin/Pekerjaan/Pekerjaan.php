                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfile.php?ref=<?php echo urlencode('/Sikompen/vendor/Admin/pekerjaan/pekerjaan.php'); ?>"
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-3">
                <button onclick="window.location.href='import_excel.php'"
                ...
                <button onclick="window.location.href='TambahDataPekerjaan.php'"
                    class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 flex items-center">
                    <i class="fas fa-plus mr-2"></i> Tambah Data
                </button>
                <button
                    onclick="if(confirm('Are you sure you want to delete all jobs?')) window.location.href='DeletePekerjaan.php?delete_all=true'"
        ...
        // Konversi jam ke menit untuk tampilan
        $jamPekerjaan = floatval($row['JAM_PEKERJAAN']);
        $menitPekerjaan = intval($jamPekerjaan * 60);
    ?>
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($menitPekerjaan); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-900">
                        <?php echo htmlspecialchars($row['DETAIL_PEKERJAAN']); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['BATAS_PEKERJA']); ?>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-900">
                        <?php echo htmlspecialchars($row['ID_PENANGGUNG_JAWAB']); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-900">
                        <?php echo htmlspecialchars($row['PENANGGUNG_JAWAB']); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <a href="editPekerjaan.php?id=<?php echo htmlspecialchars($row['ID_PEKERJAAN']); ?>"
                        ...
                        <a href="DeletePekerjaan.php?id=<?php echo htmlspecialchars($row['ID_PEKERJAAN']); ?>"
