...
<head>
    ...
    <title>Daftar Pengajuan PLP</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Daftar Pengajuan PLP</h1>
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfileplp.php?ref=<?php echo urlencode('/Sikompen/vendor/Admin/daftarpengajuan/daftarpengajuanplp.php'); ?>"
    ...
    <div class="max-w-7xl mx-auto px-4 mt-6">
        <div class="border-b border-gray-200 bg-white rounded-t-lg">
            <nav class="flex">
                <a href="/sikompen/vendor/plp/DaftarPengajuan/DaftarPengajuanPLP.php"
                    class="border-b-2 border-emerald-500 text-emerald-600 px-6 py-3 text-sm font-medium">
                    Pengajuan
                </a>
                <a href=/sikompen/vendor/plp/Daftardisetujui/DaftardisetujuiPLP.php
                ...
                <a href="/sikompen/vendor/plp/pekerjaan/pekerjaanPLP.php"
                    class="border-b-2 border-transparent text-gray-500 hover:text-emerald-600 hover:border-emerald-300 px-6 py-3 text-sm font-medium">
                    Pekerjaan
                </a>
            </nav>
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <?php else: ?>
            <!-- Table -->
            <form id="submission-form" method="POST" action="DaftarPengajuanPLP.php">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            <?php if ($pengajuan['STATUS_APPROVAL1'] !== 'BERHASIL'): ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <?php if ($pengajuan['STATUS_APPROVAL1'] !== 'BERHASIL'): ?>
                                            <button type="submit" formaction="process_approval.php" formmethod="POST"
                                                name="pengajuan_id" value="<?php echo $pengajuan['ID_PENGAJUAN']; ?>"
