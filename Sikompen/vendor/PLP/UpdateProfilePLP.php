...
$message = '';
$messageType = '';
$referrer = isset($_GET['ref']) ? $_GET['ref'] : 'daftarpengajuan/daftarpengajuanplp.php';
$referrer = filter_var($referrer, FILTER_SANITIZE_URL);

// Validasi referrer yang diizinkan
// Validasi referrer yang diizinkan
$allowedPaths = [
    '/Sikompen/vendor/plp/daftarpengajuan/daftarpengjuanplp.php',
    '/Sikompen/vendor/plp/daftardisetujui/daftardisetujuiplp.php',
    '/Sikompen/vendor/plp/pekerjaan/pekerjaanplp.php'
    
];

if (!in_array($referrer, $allowedPaths)) {
    $referrer = 'daftarpengajuan/daftarpengajuanplp.php';
}
