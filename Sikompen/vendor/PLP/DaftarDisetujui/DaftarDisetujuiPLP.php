...
if (!empty($search)) {
    $where = " AND (UPPER(m.nama) LIKE UPPER(:search) 
...
// Modify the table display section
?>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Daftar Disetujui PLP</h1>
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfileplp.php?ref=<?php echo urlencode('/Sikompen/vendor/Admin/daftardisetujui/daftardisetujuiplp.php'); ?>"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button type="button" onclick="viewPengajuan('<?php echo $pengajuan['ID_PENGAJUAN']; ?>')"
