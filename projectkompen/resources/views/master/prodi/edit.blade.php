...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Edit Prodi</div>
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item" aria-current="page">
                    <a href="{{ route('master.prodi.listprodi') }}">List Prodi</a>
                </li>
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form method="POST" action="{{ route('prodi.edit.proses') }}">
                    @csrf
                    <!-- hidden old id -->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $dataProdi->prodi }}" class="form-control" id="prodi" name="prodi">
                    </div>
