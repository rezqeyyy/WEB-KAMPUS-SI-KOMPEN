        ...
        <div class="col-12">
            <div class="card radius-15">
                <div class="card-body">
                    ...
                    <form id="approveForm" action="{{ route('master.pengajuan.adminCeklistPaksaAcc') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success btn-sm"
                                                href="{{ route('master.pengajuan.edit', ['kode_kegiatan' => $pengajuan->kode_kegiatan]) }}">
                                                <i class="fas fa-eye"></i> Lanjuti
                                            </a>
                                            @endif
                                        </td>
