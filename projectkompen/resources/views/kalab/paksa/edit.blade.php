    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="editForm"
                        action="{{ route('kalab.paksa.edit.proses', ['kode_kegiatan' => $dataPengajuan->kode_kegiatan]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <br>
                        <div class="form-group">
                            <button type="button" class="btn btn-primary" id="submitBtn">Paksa Setujui
                                Pengajuan</button>
                            <a href="{{ route('kalab.paksa.listpengajuan') }}" class="btn btn-secondary">Back</a>
                        </div>
                    </form>
                </div>
            </div>
