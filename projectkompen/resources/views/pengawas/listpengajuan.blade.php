        ...
        <div class="col-12">
            <div class="card radius-15">
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('pengawas.listpengajuan') }}" class="form-inline">
                        <div class="row mb-2">
                            <div class="col-md-2">
                                ...
                                <select class="custom-select mr-sm-2" id="kelas" name="kelas">
                                    ...
                                    <option value="{{ $kelasOption->kelas }}" {{ $selectedKelas==$kelasOption->kelas ?
                                        'selected' : '' }}>
                                        {{ $kelasOption->kelas }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="custom-select mr-sm-2" id="semester" name="semester">
                                    <option value="">All</option>
                                    @foreach ($semesterOptions as $semesterOption)
                                    <option value="{{ $semesterOption->semester }}" {{
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-warning btn-sm" disabled>
                                                <i class="fas fa-clock"></i> Menunggu Bukti Tambahan
                                            </button>
                                            @else
                                            <a class="btn btn-success btn-sm"
                                                href="{{ route('pengawas.edit', ['kode_kegiatan' => $pengajuan->kode_kegiatan]) }}">
                                                <i class="fas fa-eye"></i> Teruskan
                                            </a>
                                            @endif
                                        </td>
