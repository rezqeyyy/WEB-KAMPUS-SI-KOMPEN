        ...
        <div class="authentication-lock-screen d-flex align-items-center justify-content-center">
            <div class="card shadow-none bg-transparent">
                <div class="card-body p-md-10 text-center">
                    ...
                    <div class="">
                        <img src="{{asset('assets/images/logo_pnj.png ')}}" class="mt-5" width="250 " alt=" />
                    </div>
                    <h3 class="mt-4 text">Welcome</h3>
                    
                    <a href="{{ url('/loginmhsw') }}"
                        class="btn btn-primary btn-md lis-rounded-circle-50 px-4 mx-1 my-1 btn-admin-umum"
                        data-abc="true"><i class="fa fa-shopping-cart pl-2"></i>Login Mahasiswa</a>
