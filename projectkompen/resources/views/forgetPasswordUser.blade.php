...
<head>
    ...
    <title>Lupa Password User</title>
    <!--favicon-->
            ...
            <div class="card shadow-lg forgot-box">
                <div class="card-body p-md-5">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/icons/img_398183.png') }}" width="140" alt="" />
                    </div>
                    <h4 class="mt-5 font-weight-bold text-center">Forgot Password?</h4>
                    <p class="text-muted">Enter your registered NIP to reset the password</p>
                    <form method="POST" action="{{ route('ValidasiToken') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mt-4 mb-3">
                            ...
                            <div class="mb-3" style="display: inline-flex; align-items: center;">
                                <input type="text" class="form-control form-control-lg radius-30 mx-1"
                                    style="width: 250px" placeholder="NIP" name="kode_user" id="kode_user" required />
